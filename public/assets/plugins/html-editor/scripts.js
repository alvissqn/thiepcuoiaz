...
$(document).ready(function(){
		...
		var textJustify=[
			...
			{type: "justifyCenter",icon: "middle"},
		...
		var ulList=[
			{title: '<i class="bx bxs-circle"></i> Tròn đặc', style: "disc"},
			{title: '<i class="bx bx-radio-circle"></i> Tròn viền', style: "circle"},
			{title: '<i class="bx bxs-square"></i> Vuông', style: "square"}
		];
		var smile = [
		...
		var add=[
			{type: "slider", icon: "bx-images", title: "Slider ảnh", class: "form-file-select-custom"},
			//{type: "panel", icon: "bx-hide", title: "Menu ẩn hiện"},
			//{type: "timeline", icon: "bx-dots-vertical-rounded", title: "Timeline"},
			{type: "quote", icon: "bxs-quote-left", title: "Trích dẫn"},
			{type: "code", icon: "bx-code", title: "Mã nguồn", class: "execCommand"},
			{type: "newPage", icon: "bxs-collection", title: "Thêm trang mới", class: "execCommand"},
			{type: "script", icon: "bxs-file-js", title: "Mã JavaScript", class: "execCommand"}
		];

	$("body").append('<div id="editorPopup"></div><div class="modal fade" id="editorAsHTML" tabindex="-1" role="dialog" aria-labelledby="myModalLabel1" aria-hidden="true">');
	var editorID=0;
	...
	$("textarea.editor-textarea").filter(function(){
		...
		for(var i=0;i<button.length;i++){
			...
			for(var iB=0;iB<btn.length;iB++){
				out+='<span class="editor-buttonBox editor-buttonBox-'+btn[iB].type+'" title="'+btn[iB].title+'">';
				out+='<button class="editor-button-'+btn[iB].type+' '+btn[iB].class+'" data-value="'+btn[iB].value+'" type="button" data-type="'+btn[iB].type+'"><i class="bx '+btn[iB].icon+'"></i> </button>';	
				//Sub menu
				if(typeof btn[iB].sub!="undefined"){
					...
					switch(btn[iB].sub){
						...
						//Chọn màu
						case "color":
							out+='<div class="input-color"><div class="pd-10px">Chọn màu</div> <input class="form-control" type="color" value="#EAEAEA"></div><button data-type="color" data-color="'+btn[iB].id+'" class="editor-btn-block"  type="button" data-type="color"><i class="pd-5 bx bx-check"></i> </button>';
						break;
						...
						case "align":
							for(var ic=0;ic<textJustify.length;ic++){
								out+='<button class="editor-button-'+textJustify[ic].type+' execCommand" data-value="" type="button" data-type="'+textJustify[ic].type+'"><i class="bx bx-align-'+textJustify[ic].icon+'"></i> </button>';
							}
						break;
						...
						case "fontFamily":
							for(var ic=0;ic<fontFamily.length;ic++){
								out+='<button class="editor-btn-block editor-button-fontName execCommand" data-value="'+fontFamily[ic].value+'" type="button" data-type="fontName"> <span class="pd-5" style="font-family:'+fontFamily[ic].value+'">'+fontFamily[ic].name+'</span> </button>';
							}
						break;
						...
						case "fontSize":
							for(var ic=0;ic<fontSize.length;ic++){
								out+='<button style="display:block" class="editor-btn-block editor-button-fontSize" data-value="'+fontSize[ic]+'px" type="button" data-type="fontSize"> <span class="pd-5" style="font-size:'+fontSize[ic]+'px;">'+fontSize[ic]+'px</span> </button>';
							}
						break;
						...
						case "link":
							out+='<div class="left">';
							out+='<div style="padding: 5px"><input class="editor-link editor-link-url form-control" type="text" placeholder="http://"></div>';
							out+='<div style="padding: 5px"><input class="editor-link editor-link-title form-control" type="text" placeholder="Tiêu đề"></div>';
							out+='<div style="padding: 5px"><label class="check"><input class="editor-link editor-link-target" type="checkbox" value="1"><s></s> Mở tab mới</label></div>';
							out+='<div style="padding: 5px"><label class="check"><input class="editor-link editor-link-nofollow" type="checkbox" value="1" checked><s></s> Nofollow</label></div>';
							out+='<div style="padding: 5px" class="text-right"><button class="btn btn-primary" type="button" data-type="link"><i class="bx bx-check"></i></button></div>';
							out+='</div>';
						break;
						...
						//File
						case "embed":
							out+='<div class="menu-bg bd-b pd-15 editor-embed-switch link" data-show="image"><i class="bx bx-image"></i></div>';
							out+='<div class="menu bd-b pd-15 editor-embed-switch link" data-show="video"><i class="bx bx-video"></i></div>';
							out+='<div class="menu bd-b pd-15 editor-embed-switch link" data-show="audio"><i class="bx bx-volume"></i></div><div class="clearfix"></div>';
							out+='<div class="menu bd-b editor-upload-btn link form-file-select-custom"><i class="bx bx-upload"></i> Tải lên</div>';

							//Chèn ảnh
							out+='<div class="left editor-embed editor-embed-image">';
							out+='<div class="pd-5px"><input class="form-control editor-image editor-image-url" type="text" placeholder="Link ảnh"></div>';
							out+='<div class="pd-5px"><input class="form-control editor-image editor-image-title" type="text" placeholder="Tiêu đề ảnh"></div>';
							out+='<div class="pd-5px"><textarea class="form-control editor-image editor-image-description" placeholder="Mô tả ảnh"></textarea></div>';
							out+='<div class="pd-5px text-right"><button class="btn btn-primary" type="button" data-type="image"><i class="bx bx-check"></i></button></div>';
							out+='</div>';

							//Chèn video
							out+='<div class="left editor-embed editor-embed-video hide">';
							out+='<div class="pd-5px"><input class="form-control editor-video editor-video-url" type="text" placeholder="Link youtube hoặc link video"></div>';
							out+='<div class="alert-warning">Link youtube có dạng:<br/> https://www.youtube.com/watch?v=aVoR8hi4aL0</div>';
							out+='<div class="pd-5px text-right"><button  class="btn btn-primary" type="button" data-type="video"><i class="bx bx-check"></i></button></div>';
							out+='</div>';

							//Chèn audio
							out+='<div class="text-left editor-embed editor-embed-audio hide">';
							out+='<div class="pd-5px"><input class="form-control editor-audio editor-audio-url" type="text" placeholder="Link audio"></div>';
							out+='<div class="pd-5px text-right"><button class="btn btn-primary" type="button" data-type="audio"><i class="bx bx-check"></i></button></div>';
							out+='</div>';
						...
						case "add":
							for(var ic=0;ic<add.length;ic++){
								out+='<button title="'+add[ic].title+'" data-tag="'+add[ic].tag+'" data-class="'+add[ic].class+'" data-text="'+add[ic].text+'" class="editor-button-'+add[ic].type+' '+add[ic].class+'" data-value="" type="button" data-type="'+add[ic].type+'"><i class="bx '+add[ic].icon+'"></i> </button>';
							}
						break;

						//Trợ giúp
						case "help":
							out+='<div style="padding: 10px">Ấn chuột phải để chỉnh từng mục</div>';
							out+='<div style="padding: 10px">Ấn giữ enter+shift để xuống dòng văn bản</div>';
							out+='<div style="padding: 10px">CTRL+shift+V để dán dạng văn bản</div>';
		...
		wrap.on("click",".editor-toolbar button", function(e){
			...
			switch(type){
				...
				//Nội dung ẩn/hiện
				case "panel":
					insertHTML('<div class="panel panel-default"><div class="heading link">Tiêu đề</div><div class="panel-body hide">Nội dung bị ẩn','</div></div>',true);
				break;
		...
		wrap.on("click", ".editor-drag-table", function(e){
			...
			insertHTML('<table class="table table-bordered" style="width:100%">'+table,'</table>', false);
			$(".editor-buttonBox-showSub section").hide();
		});
	...
	function insertAudio(audio){
		if(audio.length>0){
			insertHTML('<div class="media audio"><div data-noinstallscript="1" class="media-player audio" style="max-width:100%;height:200px;" data-config="download no-ads"><div class="media-meta"><img alt="Audio" src="link-poster"><span class="audio-info"><span class="audio-title"> <i class="bx bx-music"></i> <span>Tên bài hát</span> </span><span class="audio-singer"><i class="bx fa-microphone"></i> <span>Tên ca sĩ</span> </span><span class="audio-year"><i class="bx fa-clock-o"></i> <span>201x</span></span></span></div>'+audio+'</div></div>', '</div>', false);
	...
	$("#editorPopup").on("click", ".panel .link", function(e){
		...
		$(".panel .hide").not(thisEl.children(".hide")).slideUp();
		thisEl.children(".hide").slideToggle();
	...
	function popup(menu, e, id, width){
		...
		menu.unshift(
			{type: "block"},
			{type: "btn", title: "Loại bỏ", icon: "bx-trash", action: "remove"},
			{type: "btn", title: "Sửa mã HTML", icon: "bx-code", action: "html"},
			{type: "btn", title: "Chèn khối trên", icon: "bxs-to-top", action: "before"},
			{type: "btn", title: "Chèn khối dưới", icon: "bxs-download", action: "after"},
			{type: "btn", title: "Chuyển lên", icon: "bx-chevron-up", action: "up"},
			{type: "btn", title: "Chuyển xuống", icon: "bx-chevron-down", action: "down"},
			{type: "endblock"}
		);
		menu.forEach(function(cog,i){
			...
			switch(cog.type){
				...
				case "btn":
					out+='<span data-action="'+cog.action+'" title="'+cog.title+'"><i class="bx '+cog.icon+'"></i></span>';
				break;

				case "link":
					out+='<a><span data-action="'+cog.action+'" title="'+cog.title+'"><i class="bx '+cog.icon+'"> '+cog.title+'</i></span></a>';
				break;
				...
				case "group":
					out+='<div class="panel panel-default"><div class="heading link">'+cog.title+'</div><div class="panel-body hide">';
				break;
				...
				case "input":
					out+='<div class="block"><input '+attr+' class="form-control" type="text" data-action="'+cog.action+'" value="'+value+'" placeholder="'+cog.title+'" required/></div>';
				break;

				case "textarea":
					out+='<div class=""><textarea data-action="'+cog.action+'" placeholder="'+cog.title+'">'+value+'</textarea></div>';
				break;

				case "checkbox":
					out+='<div class="pd-5px"><input style="width: 30px" type="checkbox" data-action="'+cog.action+'" value="1" '+(cog.checked ? 'checked' : '')+'/> '+cog.title+'</div>';
				break;

				case "select":
					out+='<div><select class="form-control" title="'+cog.title+'" data-action="'+cog.action+'">';
				...
				case "color":
					out+='<div class="input-color"><input style="height: 50px" class="form-control editor-color-picker" data-changed="0" data-action="'+cog.action+'" type="color" value="'+(value.length>2 ? colorToHex(value) : '#EAEAEA')+'"> <i class="editor-remove-color bx bx-x"></i> <span>'+cog.title+'</span></div>';
				break;
	...
	$(".editor").on("contextmenu", ".editor-textarea-clone .slider", function(e){
		...
		$(this).find("li").each(function(i){
			...
			sub.push({html: '<div data-id="'+i+'" class="editor-option-body '+(i==0 ? '' : 'hide')+'">'});
	...
	function editorAsHTML(content, save){
		...
		if(save){
			...
			$("#editorAsHTML").html("");
			$("#editorAsHTML").modal('hide');
			$("body").css({"overflow": ""});
		}else{
			//Sửa
			$("body").css({"overflow": "hidden"});
			$("#editorAsHTML").html(`
				<div class="modal-dialog modal-dialog-scrollable" role="document" style="max-width: 980px">
					<div class="modal-content">
						<div class="modal-header">
							<h3 class="modal-title" id="myModalLabel1">HTML Source</h3>
